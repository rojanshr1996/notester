...
class CreateUpdateNoteView extends StatefulWidget {
  ...
  const CreateUpdateNoteView({Key? key, this.note}) : super(key: key);
                                            ...
                                            child: TextField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                hintStyle: Theme.of(context).textTheme.titleMedium?.copyWith(
                                                    color: Theme.of(context).colorScheme.outline, fontWeight: medium),
                                      ...
                                      child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintStyle: Theme.of(context).textTheme.labelLarge?.copyWith(
                                              color: Theme.of(context).colorScheme.outline, fontWeight: regular),
                                          border: const UnderlineInputBorder(borderSide: BorderSide.none),
                                        ),
                                      ),
                                    ),
                                                              ...
                                                              InkWell(
                                                                onTap: () {
                                                                  Utilities.openNamedActivity(
                                                                      ...
                                                                      arguments: ImageArgs(imageUrl: _imageUrl.value));
                                                                },
                                                                child: Container(
                                                                  height: 140,
